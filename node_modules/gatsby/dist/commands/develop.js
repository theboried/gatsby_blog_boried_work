...
const sourceNodes = require(`../utils/source-nodes`); // const isInteractive = process.stdout.isTTY
...
function _startServer() {
  _startServer = _asyncToGenerator(function* (program) {
...
function () {
  var _ref = _asyncToGenerator(function* (program) {
    ...
    compiler.plugin(`done`, stats => {
      ...
      const isSuccessful = !messages.errors.length && !messages.warnings.length; // if (isSuccessful) {
