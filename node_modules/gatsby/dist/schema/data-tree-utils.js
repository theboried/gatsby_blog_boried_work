...
const extractFieldExamples = (nodes // $FlowFixMe
) => _.mergeWith(_.isArray(nodes[0]) ? [] : {}, ..._.cloneDeep(nodes), (obj, next, key, po, pn, stack) => {
  if (obj === INVALID_VALUE) return obj; // TODO: if you want to support infering Union types this should be handled
  ...
  if (!areAllSameType(array)) return INVALID_VALUE; // Linked node arrays don't get reduced further as we
