...
module.exports = (basePath, filePath) => {
  const relativePath = _path.default.posix.relative((0, _slash.default)(basePath), (0, _slash.default)(filePath));

  const _parsePath = (0, _parseFilepath.default)(relativePath),
