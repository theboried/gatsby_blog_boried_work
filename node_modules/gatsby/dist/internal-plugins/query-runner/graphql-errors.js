...
var _babelCodeFrame = _interopRequireDefault(require("babel-code-frame"));
...
function getCodeFrame(query, lineNumber, column) {
  return (0, _babelCodeFrame.default)(query, lineNumber, column, {
    linesAbove: 10,
    linesBelow: 10
  });
}
...
function getCodeFrameFromRelayError(def, extractedMessage, error) {
  let _ref2 = findLocation(extractedMessage, def) || {},
      start = _ref2.start,
      source = _ref2.source;
  ...
  let _ref3 = source && (0, _graphql.getLocation)(source, start) || {},
      line = _ref3.line,
      column = _ref3.column;
