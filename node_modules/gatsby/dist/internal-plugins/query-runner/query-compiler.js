...
class Runner {
  constructor(baseDir, fragmentsDir, schema) {
    ...
    Object.defineProperty(this, "fragmentsDir", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: void 0
  ...
  write(nodes) {
    ...
    return (0, _asyncToGenerator2.default)(function* () {
      ...
      const printContext = printTransforms.reduce((ctx, transform) => transform(ctx, _this3.schema), compilerContext);
      compilerContext.documents().forEach(node => {
        ...
        compiledNodes.set(filePath, {
          name,
          text,
          path: _path.default.join(_this3.baseDir, filePath)
        });
      });
      return compiledNodes;
    })();
